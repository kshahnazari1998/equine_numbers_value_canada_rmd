...
There was a cool paper about machine learning once [@michie1994machine]
...
```{r plot province, fig.width=6, fig.height=5, fig.cap=paste("Figure 2 Horse populations for" , params$province, " between 1940-172"),out.width="50%"}
